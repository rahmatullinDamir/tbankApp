...
class RegisterViewController: UIViewController {
    ...
    private lazy var phoneNumberTextField: ValidatedTextField = {
        let field = ValidatedTextField(textField: CustomTextField(placeholder: "Номер телефона", keyboardType: .phonePad))
        return field
    }()

    private lazy var nameTextField: ValidatedTextField = {
        let field = ValidatedTextField(textField: CustomTextField(placeholder: "Имя"))
    ...
    private lazy var surnnameTextField: ValidatedTextField = {
        let field = ValidatedTextField(textField: CustomTextField(placeholder: "Фамилия"))
        field.textField.delegate = self
        field.textField.returnKeyType = .next
    ...
    private lazy var passwordTextField: ValidatedTextField = {
        let field = ValidatedTextField(textField: CustomTextField(placeholder: "Пароль", keyboardType: .default))
    ...
    private lazy var confirmPasswordTextField: ValidatedTextField = {
        let field = ValidatedTextField(textField: CustomTextField(placeholder: "Подтверждение пароля", keyboardType: .default))
        field.textField.isSecureTextEntry = true
        field.textField.delegate = self
